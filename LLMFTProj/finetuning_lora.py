...
def set_args():
    ...
    parser.add_argument('--output_dir', default='output_dir_lora/', type=str, help='模型保存路径')
    ...
    parser.add_argument('--lora_r', type=int, default=8, help='低秩矩阵维度')
