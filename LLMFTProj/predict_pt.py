...
def set_args():
    ...
    parser.add_argument('--device', default='3', type=str, help='模型推理的设备信息')
    parser.add_argument('--model_dir', default="output_dir_pt/global_step-2160/", type=str, help='训练后的模型文件')
